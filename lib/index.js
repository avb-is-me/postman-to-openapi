...
function parseResponseFromExamples (responses, responseHeaders) {
  ...
  const statusCodeMap = responses
    .reduce((statusMap, { name, code, description, header, body, _postman_previewlanguage: language }) => {
      console.log("THIS IS THE RESPONSE DUDE", statusMap)
      ...
      console.log("this is the responses ager", statusMap)
      return statusMap
    }, {})
  // Parse for OpenAPI
